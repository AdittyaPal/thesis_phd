...
{\sffamily\slshape This chapter is identical to Section 3 of the published version of the preprint at \href{https://arxiv.org/abs/2504.10609}{arXiv:2504.10609}.\\}
...
In this chapter, we detail our proposed methodology for automating the search for kinetically informed pathways in reaction networks. As shown in Figure~\ref{fig: thermoEnergyBarrierCases}, the kinetics of the reaction can often lead to different results than those obtained from the reaction thermodynamics as done in \newpage
