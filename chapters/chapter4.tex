...
\begin{figure}[!t]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[scale=1.25]{graphics/chapter4/subset1.pdf}
        \vspace{0.2cm}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[scale=1.25]{graphics/chapter4/subset2.pdf}
        \vspace{0.2cm}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[scale=1.25]{graphics/chapter4/overlap.pdf}
        \vspace{0.2cm}
