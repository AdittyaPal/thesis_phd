%************************************************
\chapter[Formamide Chemistry]{Case Study: Formamide Chemistry}
\label{ch:casestudy1} %
%************************************************
...
\section{Assigning Chemical Potentials}\label{first appendix}
...
\begin{figure}[!t]
	\vspace{1cm}
    \centering
    \includegraphics[width=0.75\textwidth]{graphics/chapter3/sampleConformer.pdf}
    \vspace{0.5cm}
...
\section{Ranges for Concentration Variables}\label{second appendix}
...
\section{Pathways to Formamide trimer}
