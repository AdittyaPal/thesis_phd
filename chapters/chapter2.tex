...
%************************************************
\chapter{A Constraint-based Model}
\label{ch:thermodynamic_model}
%************************************************

{\sffamily\slshape The text in this chapter is identical to Section 3 of the published version of the preprint at \href{https://arxiv.org/abs/2411.15900}{arXiv:2411.15900} along with some additional figures.\\}
...
\begin{figure}[!t]
    ...
    \begin{subfigure}{0.9\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{graphics/chapter2/heatEngine.pdf}
    ...
    \begin{subfigure}{0.9\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{graphics/chapter2/heatPathway.pdf}
...
\begin{figure}[!t]
    ...
    \begin{subfigure}{0.9\textwidth}
        \centering
        \includegraphics[width=\textwidth]{graphics/chapter2/thermPathway.pdf}
    ...
    \begin{subfigure}{0.9\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{graphics/chapter2/thermConstraints.pdf}
...
Since we are extending the existing integer hyperflow formulation defined earlier, the base ILP formulation for modeling flow conservation in pathways in reaction networks is inherited from that work.
\begin{equation}
\forall v\in V\colon \sum_{ e\in \overline{E} } s_{ve}^+ f_e - \sum_{ e\in \overline{E} } s_{ve}^- f_e = 0
\tag{\ref{int_hyperflow_jakob}}
\end{equation}
The working of Constraint~\ref{int_hyperflow_jakob} is illustrated in the four example cases in Figure~\ref{fig: flowConv}. 
...
\begin{table}[!t]
    ...
    \end{tabular}
    \end{scriptsize}
    \caption{Variables in the proposed MILP formulation. The variables $M$ and $x^{G^0}_v$ are assigned as input parameters,
...
\begin{figure}[!h]
	\centering
	\vspace{0.5cm}
    \includegraphics[width=0.8\textwidth]{graphics/chapter2/thermoConstraint.pdf}
    \vspace{0.5cm}
...
\begin{figure}[!t]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{graphics/chapter2/concTweak1.pdf}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{graphics/chapter2/concTweak2.pdf}
...
In this short chapter, we give a detailed comparison of our methods with some existing frameworks.
