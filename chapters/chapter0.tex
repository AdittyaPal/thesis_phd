...
{\sffamily\slshape The text in this chapter is identical to Section 2 of the published version of the preprint at \href{https://arxiv.org/abs/2411.15900}{arXiv:2411.15900}.\\}
...
\begin{figure}[!t]
	\centering
	\vspace{0.5cm}
    \includegraphics[scale=1.0]{graphics/chapter0/hyperedge.pdf}
    \vspace{0.2cm}
...
\begin{figure}[!t]
	\centering
	\vspace{0.5cm}
    \includegraphics[scale=1.0]{graphics/chapter0/hyperedge_catalyst.pdf}
    \vspace{0.2cm}
    \caption{Directed hyperedges allow the specification of a molecule as a catalyst in a reaction. A copy of the molecules $v_1$ acts as a catalyst in the transformation of a copy of the molecule $v_0$ into a copy of $v_2$.}
    \label{fig: hyperedge}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \vspace{1.0cm}
    \includegraphics[scale=1.0]{graphics/chapter0/hypergraph.pdf}
    \vspace{0.2cm}
...
\begin{figure}[!t]
	\centering
    \includegraphics[scale=1.0]{graphics/chapter0/flowQuery.pdf}
    \vspace{0.5cm}
